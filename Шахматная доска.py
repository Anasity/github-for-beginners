...
if fig==1: #если фигура - ферзь
    if abs(k-m) == abs(l-n) or k == m or l == n: #если поля находятся на одной горизонтали, вертикали или диагонали
        ...
        print('Чтобы попасть на поле (',m, ', ',n,'), нужно переместиться на поле (',k, ', ',n,')',sep='')
    ...
    if abs(k-m) == abs(l-n): #если поля находятся на одной горизонтали или диагонали
        ...
        x=(m+n+k-l)//2 
        y=(m+n-k+l)//2
        print('Чтобы попасть на поле (',m, ', ',n,'), нужно переместиться на поле (',x, ', ',y,')',sep='')
